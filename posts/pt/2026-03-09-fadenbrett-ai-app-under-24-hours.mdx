...
date: '2026-03-09'
description: >-
  Criei um quadro de investigação digital self-hosted do zero em menos de 24 horas
  usando Claude e Claude Code. Como a IA está mudando o processo de criação —
  e como instalei tudo no Proxmox com um único comando.
tags:
  - ia
  - self-hosting
  - proxmox
