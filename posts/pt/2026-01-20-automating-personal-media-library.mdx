---
title: >-
  Automatizando minha biblioteca de mídia pessoal com Docker e serviços
  auto-hospedados
date: '2026-01-20'
description: >-
  Como construí um sistema completo de gerenciamento e organização de mídia
  pessoal usando Jellyfin, Sonarr, Radarr, Bazarr e outras ferramentas
  open-source.
tags:
  - homelab
  - self-hosting
...
Como mencionei no [post anterior](/pt/blog/my-networking-professor-was-right), tudo roda no meu servidor caseiro com **Proxmox VE**. Criei um container LXC dedicado para esse stack de mídia, o que garante isolamento e facilita gerenciamento.
...
Cada serviço tem um IP fixo na minha rede (lembra do [post sobre organização de rede](/pt/blog/my-networking-professor-was-right)?):
