...
date: '2025-12-18'
description: >-
  After using AI daily, my vision became clear: AI doesn't replace developers,
  but it changes who remains relevant.
tags:
  - ai
  - career
  - development
...
This discourse is not new. It has appeared with modern frameworks, with low-code, with no-code — and now with AI.

The difference is that, for the first time, **AI actually writes usable code**.  
And after using AI daily in my workflow, my vision today is clear:
...
This doesn't mean these will be “the best” forever.  
It just means that **these are the ones that worked best for me now**.
...
But today, for UI/UX, it greatly accelerates the phase where I would normally lose more time.
...
In my current experience, **Claude Opus 4.5** stood out in:

- business logic
- backend code organization
- reading legacy code
- careful refactorings
- architecture discussion and trade-offs

It tends to be more conservative, which is positive in systems where making mistakes is costly.
...
## Launching projects faster changes the way of working

One of the most visible impacts of AI today is the reduction of time between an idea and something running.
...
The project didn't lose its identity or quality.  
...
The **Cursor** became present in my daily life because:
...
The **Antigravity** stands out mainly when the project grows:
- better navigation between files
- understanding dependencies
- a more architectural view of the system
- less time lost chasing references
...
- handle implicit rules of old systems well
...
- Mids who only execute tasks tend to stagnate
...
## Where to consistently follow this topic

Some sources that make sense to follow today, knowing that everything changes fast:
...
My vision, based on what I am using and testing now, is simple:
