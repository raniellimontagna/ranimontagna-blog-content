---
title: 'Fadenbrett: how AI helped me build a full app in under 24 hours'
date: '2026-03-09'
description: >-
  I built a self-hosted digital investigation board from scratch in under 24
  hours using Claude, Ralph, and Claude Code. How AI is changing the creation
  process — and how I deployed everything to Proxmox with a single command.
tags:
  - ai
  - self-hosting
  - proxmox
