...
In my [previous post about my home server](/en/blog/2025-12-22-my-networking-professor-was-right), I showed how I organized my home network with Proxmox, Pi-hole and other services. One of the centerpieces was **[Jellyfin](https://jellyfin.org/)** — an open-source media server to organize and play my personal collection.
...
As I mentioned in my [previous post](/en/blog/2025-12-22-my-networking-professor-was-right), everything runs on my home server with **Proxmox VE**. I created a dedicated LXC container for this media stack, which ensures isolation and makes management easier.
...
Each service has a fixed IP on my network (remember the [post about network organization](/en/blog/2025-12-22-my-networking-professor-was-right)?):
