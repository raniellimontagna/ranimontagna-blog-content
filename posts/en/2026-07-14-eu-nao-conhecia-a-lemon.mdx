...
I am joining in a software engineering capacity, working at the intersection of the Center of Excellence (COE) and the Finance team.

The plan is to bring an engineering background to improve the day-to-day of the people who work with finance: reducing reliance on spreadsheets, automating manual and repetitive processes, and turning real needs into digital solutions. I have not started the work itself yet — this is the scope ahead of me. Before proposing answers, there are questions to ask: where is time being lost? Which information stays fragmented? Which decisions could be better informed? Where can technology simplify the operation without creating another layer of difficulty? Before proposing answers, there are questions to ask: where is time being lost? Which information stays fragmented? Which decisions could be better informed? Where can technology simplify the operation without creating another layer of difficulty?

I am excited by this connecting role because software becomes more meaningful when it begins with a concrete problem. The Finance team understands the day-to-day work, the exceptions, and the cost of friction. Engineering can help turn that knowledge into clearer, more reliable, and more sustainable systems and processes. The COE can build the bridge that keeps lessons and patterns from being trapped inside a single solution.
...
I want to put on record a thank-you to Lemon for the interview process. It was one of the most transparent, thoughtful, and encouraging I have ever been through — every stage left me more excited about the decision, not less. Leaving a process more enthusiastic than I entered says a lot about the people and the culture I found along the way.
