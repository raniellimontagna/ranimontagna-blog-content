...
description: >-
  ...
  orquestar contexto, planificación y ejecución, la calidad del software sube de
  nivel. Un análisis técnico de GSD (Get Shit Done) y del flujo que estoy usando
  en el día a día.
tags:
  - ia
  - productividad
