---
title: 'La IA no reemplazará a los devs, pero filtrará'
date: '2025-12-18'
description: >-
...
La pregunta importante no es *si* la IA te va a reemplazar, sino **en qué capa del problema actúas hoy**.

---

## Lo que la IA ya hace mejor que muchos devs

Usar IA en el día a día quita cualquier romanticismo del asunto.
...
Estas actividades siempre existieron, pero ahora **han dejado de ser un diferencial**.
...
Significa solo que **son las que funcionaron mejor para mí ahora**.
...
En mis pruebas recientes, **Gemini 3 Pro** se mostró extremadamente competente para:
...
Quizás otro modelo supere esto mañana.  
Pero hoy, para UI/UX, acelera mucho la fase donde normalmente yo perdería más tiempo.
...
Tiende a ser más conservador, lo cual es positivo en sistemas donde equivocarse cuesta caro.
...
## Subir proyectos más rápido cambia la forma de trabajar
...
Pero **ahora**, esto cambia completamente cómo nacen los proyectos personales y experimentos técnicos.
...
- reduce el tiempo intentando entender sistemas que no fui yo quien escribió

Quizás otra IDE haga esto mejor mañana.  
...
En sistemas mayores, esto reduce algo crítico hoy: **carga cognitiva**.
...
## El filtrado ya está ocurriendo

El mercado no está terminando.  
Se está ajustando al momento actual.

- Júnior sin base siente más
- Pleno que solo ejecuta tareas tiende a estancarse
- Quien entiende el *porqué* del código obtiene una ventaja real

Hoy, muchas veces:

> Un buen desarrollador con IA entrega más que varios desarrolladores medianos sin ella.
...
Algunas fuentes que hoy tienen sentido seguir, sabiendo que todo cambia rápido:
...
Va a reemplazar a **desarrolladores superficiales**.
